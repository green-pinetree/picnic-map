...
public class LocationService {
  ...
  public void saveLocation() throws JsonProcessingException {
    try {
      ...
      Map<String, Object> districtsMap = objectMapper.readValue(jsonData.toString(),
          new TypeReference<Map<String, Object>>() {
          });
      List<Map<String, Object>> districts = (List<Map<String, Object>>) districtsMap.get(
          "district");
...
//                System.out.println(location);
  ...
  public LocationDTO findNearestLocation(Double targetLatitude, Double targetLongitude) {
    return locationToLocationDTO(
        locationRepository.findNearestLocation(targetLatitude, targetLongitude));
  }

  public LocationDTO locationToLocationDTO(Location location) {
    LocationDTO locationDTO = new LocationDTO();
    locationDTO.setCode(location.getCode());
    locationDTO.setR2(location.getR2());
