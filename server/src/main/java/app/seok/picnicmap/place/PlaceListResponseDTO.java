...
public class PlaceListResponseDTO {
  ...
  public static PlaceListResponseDTO status200(List<ParkDTO> parks, List<WalkDTO> walks,
      List<CultureDTO> cultures) {
    PlaceListResponseDTO response = new PlaceListResponseDTO();
  ...
  public static PlaceListResponseDTO status404All() {
    PlaceListResponseDTO response = new PlaceListResponseDTO();
